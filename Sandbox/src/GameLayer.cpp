...
void GameLayer::OnAttach()
{
	...
	m_Font = io.Fonts->AddFontFromFileTTF("assets/OpenSans-Regular.ttf", 48.0f);
}
...
void GameLayer::OnUpdate(Nexus::Timestep ts)
{
	m_Time += ts;
...
void GameLayer::OnEvent(Nexus::Event& e)
{
	EventDispatcher dispatcher(e);
	dispatcher.Dispatch<WindowResizeEvent>(NX_BIND_EVENT_FN(GameLayer::OnWindowResize));
	dispatcher.Dispatch<MouseButtonPressedEvent>(NX_BIND_EVENT_FN(GameLayer::OnMouseButtonPressed));
}
